...
// Полностью независимо от панели LLM-ботов (порт 8765, см.
// cigilbot/bot_process_control.py) — эта панель сама запускает/
// останавливает процесс, не проксируя через 8765.
