...
Detectors в bot/moderation/detectors/ оценивают ОДНО сообщение. Здесь —
...
участника (см. bot/moderation/types.py).
...
from cigilbot.config import ClusterConfig, KeywordOverlapConfig, ModerationConfig
from cigilbot.detectors.keyword_overlap import significant_words
from cigilbot.normalize import MessageFingerprint, similarity
from cigilbot.scoring import risk_score as compute_risk_score
from cigilbot.types import ChannelContext, ClusterInfo, Signal, SignalFamily, UserState
from cigilbot.window import SlidingWindow, WindowEntry
